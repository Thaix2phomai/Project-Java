...
public class Controller {
    ...
    ArrayList<Book> bookList = service.addBook();
    ArrayList<Magazine> magazineList = service.addMagazine();
    ArrayList<DigitalDocument> documentList = service.addDigitalDocument();
    ArrayList<Library> list = new ArrayList<>();

    public void mainMenu() {
        list.addAll(bookList);
        list.addAll(magazineList);
        ...
        while (!isCheck) {
            ...
            switch (choice) {
                case 1:
                    ...
                    break;
                case 2:
                    service.findByType(list);
                    break;
                case 3:
                   service.sortByDowload(documentList);
                    break;
                case 4:
                    service.getCurrentYear(magazineList);
                    break;
                case 0:
                    isCheck = true;
                    System.exit(1);
        ...
        while (!isCheck) {
            ...
            switch (choice) {
                case 1:
                    ...
                    break;
                case 2:
                    service.printMagazine(magazineList);
                    break;
                case 3:
                    service.printDocument(documentList);
                    break;
                case 4:
                    service.printbook(bookList);
                    service.printMagazine(magazineList);
    ...
    public static void menu() {
        ...
        System.out.println("4 - Lấy ra Tạp chí được xuất bản trong năm hiện tại");
